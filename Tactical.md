...
- **Committed/Committ:** Fighter intent to engage/intercept
...
- **Very High:** Target altitude above 800m
- **Very Low:** Target altitude is below 200m
...
( ) Nose = # nosegun rounds in reserve (not counting current magazine)
( ) Secondary = # secondary arounds in reserve (not counting current magazine)
( ) Fire/Flare = Time to Fire Supression/Flares Available
